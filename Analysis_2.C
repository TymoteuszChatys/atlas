...
void CLoop::Style() {
    ...
    h_invariant_mass_ee->SetLineColor(COLOUR); // set the line colour to red
    ...
    h_invariant_mass_mumu->SetLineColor(COLOUR); // set the line colour to red
    ...
    h_invariant_mass_ee_60->SetLineColor(COLOUR); // set the line colour to red
    ...
    h_invariant_mass_mumu_60->SetLineColor(COLOUR); // set the line colour to red
    ...
    h_invariant_mass_ee2 -> Write();
    h_ptcone30_e -> Write();
    h_ptcone30_m -> Write();
    h_etcone20_e -> Write();
    h_etcone20_m -> Write();
    h_invariant_mass_ee_60 -> Write();
    h_invariant_mass_ee2_60 -> Write();
}
